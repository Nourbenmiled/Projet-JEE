...
<body>
           ...
           <div class="container-fluid">
               ...
               <div class="collapse navbar-collapse" id="navbarNav">
                   <ul class="navbar-nav">
                       ...
                       <li class="nav-item">
                           <a class="nav-link active" href="/coursteacher">Courses</a>
                       </li>
                       <li class="nav-item">
                       ...
                       <li class="nav-item">
                           <a class="nav-link" href="/noteTeacher">Notes</a>
                       </li>
                         <%--<li class="nav-item">
    ...
    <div class="container mt-4">
        <h1 class="mt-4">Course List</h1>
                <a href="/coursteacher/create" class="btn btn-primary mb-3">Add Course</a>
