    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">Consulter Cours</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">Consulter Notes</a>
                </li>
                
                 <li class="nav-item">
                    <a class="nav-link" href="#">Modifier Informations</a>
                </li>
                
                <li class="nav-item">
               		<form action="LogoutController" method="get">
               			 <a class="nav-link btn btn-danger" style="color: #ffffff;" href="">Déconnexion</a>
               		</form>
                </li>
            </ul>
        </div>
